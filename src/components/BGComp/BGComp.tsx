...
export default function BGComp() {
  ...
  useEffect(() => {
    ...
    function changeBg(e: MouseEvent) {
      container.style.background = `radial-gradient(circle at ${(e.pageX / container.offsetWidth) * 100
  ...
  return (
    <>
      ...
      {isMobile && <p>I'm sorry, it's only available on PC for now. Comig soon!</p>}
    </>
  );
}
